...
public class PacketHandler
{
    ...
    {
        INSTANCE.registerMessage(PacketOpenEquipmentInventory.class, PacketOpenEquipmentInventory.class, 0, Side.SERVER);
        INSTANCE.registerMessage(PacketOpenNormalInventory.class, PacketOpenNormalInventory.class, 1, Side.SERVER);
        INSTANCE.registerMessage(PacketSyncEquipment.class, PacketSyncEquipment.class, 2, Side.CLIENT);
